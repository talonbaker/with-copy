...
| 1 | `w1b-ui-shell.md` | `src/index.html`, `src/css/*`, `src/js/ui/{toast,undo}.js` |
| 1 | `w1c-platform.md` | `src/js/clipboard.js`, `src/probe.html`, `src/js/probe.js`, `src/sw.js`, `src/manifest.webmanifest`, `src/CNAME`, `src/icons/*`, `.github/workflows/pages.yml`, `.gitignore`, `.editorconfig` |
| 2 | `w2a-core-ui.md` | `src/js/main.js`, `src/js/ui/{stack-view,piece-card,variants,expand}.js`, edits to `index.html` and `app.css` |
| 2 | `w2b-stacks-and-settings.md` | `src/js/ui/{side-panel,settings}.js`, edits to `main.js`, `index.html`, `app.css` |
